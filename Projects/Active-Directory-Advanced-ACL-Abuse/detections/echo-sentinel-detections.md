# EchoSentinel Detection Notes — Active Directory Advanced ACL Abuse (WriteOwner on Domain Admins)
...
- Monitor 4662 and directory service change events for ownership or DACL modifications on privileged groups.
- Alert on 4728/4729 changes involving Domain Admins or other protected groups.
- Track abnormal use of directory administration tooling or PowerShell modules capable of ACL manipulation.
- Correlate privileged-group changes with immediate replication attempts, ticket anomalies, or privileged logons.
- Review AdminSDHolder- and ACL-related changes as potential persistence or privilege-escalation indicators.
